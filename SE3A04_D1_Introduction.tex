...
\label{sub:scope}
% Begin SubSection
	The product to be developed is SCEMAS, which contains many integrated components.
	...
	The IoT data ingestion is responsible for handling telemetry ingestion and validating it for correct formatting, compliance with schemas, and ensuring its within expected value ranges.
	...
	SCEMAS continuously monitors air quality, noise levels, temperature, and humidity. 
...
\label{sub:overview}
% Begin SubSection
	Section 2 discusses the overall description for SCEMAS. This includes product perspectives, functions, user characteristics, constraints, assumptions and dependencies. 
