...
\begin{enumerate}[{CP-C}2. ]
	\item All dashboard content and alerts shall be available in all official language(s) where the system is available. \\
    {\bf Rationale:} Users may have different language backgrounds depending on where the system is used. Supporting official languages improves inclusivity and reduces misunderstanding.
\end{enumerate}
...
\begin{enumerate}[{LR-COMP}1. ]
	\item Personal information handled by the system must be protected against loss, theft, and unauthorized access, disclosure, copying, use, or modification. \\
...
\begin{enumerate}[{LR-COMP}2. ]
	\item The system must obtain the user’s knowledge and consent before collecting, using, or disclosing their personal information. \\
    {\bf Rationale:} This aligns with PIPEDA Principle 3 (Consent).
\end{enumerate}

\begin{enumerate}[{LR-COMP}3. ]
	\item The system must limit collection of personal information to only what is necessary for the stated purpose(s). \\
