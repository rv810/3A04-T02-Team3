...
The system provides tailored interfaces for city operators, \textcolor{red}{administrators}, and the public. \textcolor{red}{Administrators define alert rules based on specific thresholds or anomalous trends which trigger alerts for city operators.} City operators access a secure dashboard with real-time environmental metrics, system health, and active alerts. Public users access aggregated, non-sensitive environmental data through a read-only REST API. 
...
\begin{compactitem}
    ...
    \begin{compactitem}
        \item Allows \textcolor{red}{administrators} to define new alert rules
    \end{compactitem}
    \item \textbf{Update Alert Rule}
    \begin{compactitem}
        \item Allows \textcolor{red}{administrators} to update existing alert rules
    \end{compactitem}
...
\begin{enumerate}
    ...
    \item \textcolor{red}{Administrators} are responsible for creating/updating alert rules.
