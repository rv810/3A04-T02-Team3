...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{ArchitectureDiagram.png}
    \caption{Structural Architecture Diagram}
    \label{fig:scemas_architecture}
\end{figure}
