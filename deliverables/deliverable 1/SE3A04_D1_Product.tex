...
\begin{compactitem}
    ...
    \begin{compactitem}
        \item Allows {administrators} to define new alert rules
    \end{compactitem}
    \item \textbf{Update Alert Rule}
    \begin{compactitem}
        \item Allows {administrators} to update existing alert rules
    \end{compactitem}
...
\begin{enumerate}
    ...
    \item {Administrators} are responsible for creating/updating alert rules.
